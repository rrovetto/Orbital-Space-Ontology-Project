Welcome to the landing page for the [Orbital Space Ontology & Terminology/Taxonomy Project](https://github.com/rrovetto/Orbital-Space-Ontology-Project).
<br> Ontologies available on request. Contact me at rrovetto[at]terpalum[dot]umd[dot]edu.
<br> This work has been independent, and based on the [publications](https://scholar.google.com/citations?user=jTkGEiMAAAAJ&hl=en&oi=sra) listed below. Funding and partnerships for this project has been needed since conception in 2011. The author seeks a studentship or other funded opportunity for this (or related work) to be a thesis or project. The author is open to co-authorship, and grant-writing. The author is open to collaboration with authors of similar and precedeing works. 
<br> Interested persons, professors, or organizations should contact me at rrovetto@terpalum.umd.edu

**What you can do to help**
* Interested parties should contact [the author](https://scholar.google.com/citations?user=jTkGEiMAAAAJ&hl=en&oi=sra)[DONATE HERE](https://www.patreon.com/user?u=6298778) to support the project and associated papers.

| Project Detail | Description |
| -------------|:-------------|
| Goals | The development of a semantically-rich terminology and computational ontology (or ontology suite) for the orbital debris problem astronautics in general, space traffic management, and applications thereof. To develop accurate domain reference ontologies that can be used across federated space databases for: data retrieval, data sharing, data integration; semantic interoperabiltiy; classification & terminology development; domain modeling, knolwedge modeling; etc. Philosophical & formal ontological analysis/clarification of fundamental orbital and astrodynamic concepts is a central feature of this effort. |
| Scope | Areas/Domains of Interest: orbital debris, space situational awareness(SSA), space traffic management, the orbital & near-Earth space environment, astronautics. This includes: basic orbital concepts, satellites and other space objects, spacecraft maneuvers and operations, astrodynymic models, and thus [orbital debris ontology](https://arxiv.org/abs/1704.01014)(1)(Rovetto, ESI 2015) ([PPT here](https://www.researchgate.net/profile/Robert_Rovetto/publication/311707634_Orbital_Debris_Ontology/links/585609c408ae77ec3706a80f/Orbital-Debris-Ontology.pdf?origin=publication_detail), [space situational awareness (SSA)](https://arxiv.org/abs/1606.01924)(2)(Rovetto & Kelso, 2016). |
