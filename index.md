...
<br>
<center><strong>URGENTLY NEEDING funding, or a funded work or student opportunity to work sustainably on this -</strong></center>
...
| -------------|:-------------|
| Goals | - To <strong> help resolve the orbital debris problem</strong> by developing computable taxonomies that faciliate the exchange of orbtial debris data, which seeks to provide more actionable situational awareness of the orbital space environment. <br>- The development of one ore more semantically-rich computational ontologies for orbital objects (spacecraft, debris, etc.), space situational awareness (SSA), spacecraft operations, space traffic management (STM), and applications thereof. <br>- To provide accurate<strong> domain reference ontologies </strong>that can be used as a common knowledge model and shared vocabulary across federated space debris & SSA databases for: data sharing, data integration, data search & retrieval; semantic interoperabiltiy; classification & terminology development; domain modeling. <br>- To computationally and conceptually represent knowledge of SSA and astrodynamics. <br>- The <strong>philosophical & formal analysis</strong> (and clarification) of fundamental orbital and astrodynamic concepts. <br>- Addressing orbital debris and SSA space policy issues via formal methods |
