...
| -------------|:-------------|
| Goals | The development of a semantically-rich terminology and computational ontology (or ontology suite) for astronautics, the orbital space environment and applications thereof. To develop accurate domain reference ontologies that can be used across federated space databases, for: data retrieval, sharing, integration; semantic interoperabiltiy; classification & terminology development; domain modeling, etc. The philosophical & formal ontological analysis/clarification of fundamental orbital and astrodynamic concepts. |
...
* (7) "Space Object Ontology" Rovetto, R.J. https://philpapers.org/archive/ROVSOO.pdf (forthcoming, under journal review since 2016) (NOTE: this work was plagarised by work elsewhere. Please contact me before you cite an ontology with the same name)
