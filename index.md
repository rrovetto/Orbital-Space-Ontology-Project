...
This project has been a desired PhD topic since 2011 when I thought of applying ontology to the orbital debris domain (1), thanks to David Vallado of Agi Inc. who during a space conference presentation expressed the need for more debris data-integration and sharing. My idea was to help improving the OD hazard by facilitating data sharing and integration, and to model orbital concepts. I've hoped to use this as toward a foot-in-the-door to further space eduation and ultimately work in the space sector (ideally NASA or ESA). However, since 2011 I've not been able to find a PhD or undergraduate position for this concept as a thesis/project. Additionally in that time, I spent time pursueing (if unsuccefully) a public service in search and rescue, another career goal and also another ongoing work effort. Unfortunately, in the time since ideation of the concept, persons and companies have seen the potential utility (as I sought to find opportunity) of it and ran with some of my ideas (proof available upon request), leaving me aside. A sense of urgeny to work on this (if in an unfunded way), and search for a funded opportunity to sustainably work on it, has therefore driven me to do so. I wish to work in a team environment so that I can learn from  professionals in the repsective disciplines (astrodynamics, astroinformatics, computer science, ontology engineering, etc.). As my efforts attest, I have developed many paper concepts. I'm open to co-authorship with interested parties, and have identified grants we may apply to. In pursuing this project I seek to find an opportunity to complete a STEM or interdisciplinary space degree (e.g., astronautics, astronautical engienering, astrodynamics, etc). 
