...
| -------------|:-------------|
| Goals | 
- The development of a computational ontology or ontology suite for astronautics, the orbital space environment and applications thereof. 
- To develop accurate domain reference ontologies that can be used across federated space databases, for: data retrieval, sharing, integration; semantic interoperabiltiy; classification & terminology development; domain modeling, etc. 
