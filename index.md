...
| -------------|:-------------|
| Goals | (A) Offer a standard semantics for data in the astronautical community (Metadata) <br> (B) Develop a suite of semantically-rich <strong>computational ontologies</strong> <br> (C) To <strong> help resolve the orbital debris problem</strong> by using these ontologies to faciliate the exchange of orbtial debris data, aiming to provide great situational awareness of the orbital space environment. <br> (D) To serve as<stong> upper level or domain reference ontologies</strong> for other ontologies<br> (E) To provide <strong>a common knowledge model (and <em>shared vocabulary</em>)</strong> across federated space situational awareness(SSA) databases and space object catalogs for achieving: data- sharing, integration, search & retrieval; semantic interoperabiltiy; classification; etc. <br>(F) The <strong>philosophical & formal analysis</strong> (and clarification) of fundamental domain concepts. <br> (G) To use these fomral methods to address/resolve space policy, terminology and definition issues. <br> (H) Yet unknown positive applicaitons (open to ideas)|
