...
| -------------|:-------------|
| Goals | <strong>A</strong>) - Offer a standard <strong>semantics</strong> for data in the astronautical community (<strong>Metadata</strong>) <br> <strong>B)</strong> - Develop a suite of semantically-rich <strong>computational ontologies</strong> <br> <strong>C)</strong> - To <strong> help resolve the orbital debris problem</strong> by using these ontologies to faciliate the exchange of orbtial debris data, aiming to provide great situational awareness of the orbital space environment. <br> <strong>D)</strong> - Serve as<stong> upper level or domain reference ontologies</strong> for other ontologies<br> <strong>E)</strong> - Provide <strong>a common knowledge model (and <em>shared vocabulary</em>)</strong> across federated space situational awareness(SSA) databases and space object catalogs for achieving: data- sharing, integration, search & retrieval; semantic interoperabiltiy; classification; etc. <br><strong>F)</strong> - The <strong>philosophical & formal analysis</strong> (and clarification) of fundamental domain concepts. <br> <strong>G)</strong> - Use these fomral methods to address/resolve space policy, terminology and definition issues. <br> <strong>H)</strong> - Yet unknown applicaitons (open to ideas)|
