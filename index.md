...
| -------------|:-------------|
| Goals | <ul><li> The development of a computational ontology or ontology suite for astronautics, the orbital space environment and applications thereof.</li><li> To develop accurate domain reference ontologies that can be used across federated space databases, for: data retrieval, sharing, integration; semantic interoperabiltiy; classification & terminology development; domain modeling, etc. </li><li> The philosophical & formal ontological analysis/clarification of fundamental orbital and astrodynamic concepts.</li></ul> |
