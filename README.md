...
This project consists of developing a domain reference ontology or ontology suite, whose scope is the orbital space environemnt, including space situational awareness (SSA), here collectively called the 'Orbital Space Domain'. The focus is formal representaitons of orbits, orbital phenomena, orbital concepts/knowledge, space objects (spacecraft, orbital debris), spacecraft maneuvers, and other SSA entities as well as space traffic management concepts. It is intended to be applicable to any central body or orbital reference frame, i.e., to any planet, and internationally applicable. 
